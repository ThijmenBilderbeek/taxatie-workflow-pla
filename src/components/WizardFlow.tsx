...
export function WizardFlow() {
  ...
  const getTitelForKey = (key: string): string => {
    const titels: Record<string, string> = {
      '01-voorblad': 'Voorblad',
      '02-opdracht': 'Opdracht en doel van de taxatie',
      '03-objectomschrijving': 'Objectomschrijving',
      '04-ligging': 'Ligging en bereikbaarheid',
      '05-kadaster': 'Kadastrale gegevens en eigendomssituatie',
      '06-oppervlakten': 'Oppervlakten en inhoud',
      '07-technisch': 'Bouwkundige staat en onderhoud',
      '08-huur': 'Huurgegevens en exploitatie',
      '09-vergunningen': 'Vergunningen, energielabel en milieu',
      '10-marktanalyse': 'Marktanalyse',
      '11-vergelijkingen': 'Vergelijkingsobjecten',
      '12-waardering': 'Waardering',
      '13-aannames': 'Aannames, voorbehouden en bijzonderheden',
      '14-conclusie': 'Waardeoordeel en conclusie',
      '15-referenties': 'Gebruikte referentierapporten',
      '16-ondertekening': 'Ondertekening',
    }
