...
const SECTIE_CONFIG: Record<string, SectieConfig> = {
  ...
  'c1-swot':                         { titel: 'C.1 SWOT-analyse',                     stappen: ['stap1', 'stap2', 'stap3', 'stap6', 'stap7', 'stap9'] },
  'c2-beoordeling':                  { titel: 'C.2 Beoordeling',                      stappen: ['stap1', 'stap2', 'stap3', 'stap4', 'stap5', 'stap6', 'stap7', 'stap8', 'stap9'] },
  'd1-privaatrechtelijk':            { titel: 'D.1 Privaatrechtelijke Aspecten',      stappen: ['stap2', 'stap5'] },
  'd2-publiekrechtelijk':            { titel: 'D.2 Publiekrechtelijke Aspecten',      stappen: ['stap2', 'stap5'] },
  'e1-locatie-overzicht':            { titel: 'E.1 Locatie Overzicht',               stappen: ['stap1', 'stap2', 'stap3', 'stap9'] },
  'e2-locatie-informatie':           { titel: 'E.2 Locatie Informatie',              stappen: ['stap1', 'stap2', 'stap3', 'stap6', 'stap9'] },
